...
export async function getInstagramInfo(url: string): Promise<VideoInfoResponse> {
  ...
  return {
    ...
    warnings: [
      "Real metadata from yt-dlp. Private/region-limited media can still fail extraction.",
    ],
  };
}
